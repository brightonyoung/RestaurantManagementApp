...
jQuery.tableDnD = {
    ...
    mouseCoords: function(ev) {
        // this bestEvt and targetTouches added by JGRIMM
        var bestEvt = ev;
        if (hasTouch && ev.originalEvent && ev.originalEvent.targetTouches && ev.originalEvent.targetTouches.length > 0) {
            bestEvt = ev.originalEvent.targetTouches[0];
        }
        if (bestEvt.pageX || bestEvt.pageY) {
            return {
                x: bestEvt.pageX,
                y: bestEvt.pageY
            };
        ...
        var result = {
            x: bestEvt.clientX + document.body.scrollLeft - document.body.clientLeft,
            y: bestEvt.clientY + document.body.scrollTop - document.body.clientTop
        }
        return result;
    },
    ...
    mousemove: function(ev) {
        ...
        //alert('y = ' + jQuery.tableDnD.mouseOffset.y);
