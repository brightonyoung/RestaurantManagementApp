        ...
        (function(module, exports, __webpack_require__) {
            ...
            if (typeof Toast == 'undefined') {
                ...
                var Toast = window.Toast = {
                    ...
                    trackUnsavedChanges: function trackUnsavedChanges(el) {
                        if (!el) {
                            el = $(document);
                        }
                        el.find('input,select,textarea').not('#switch-restaurants-menu input,.search-query,#propertySelector,.ignore-changes').change(function() {
                            Toast.unsavedChanges = true;
                        });
                    },
                    hasUnsavedChanges: function hasUnsavedChanges() {
                        return Toast.unsavedChanges && $('#save-btn:visible').size() > 0 && !$('#save-btn').attr('disabled');
                    },
                    confirmUnsavedChangesOnUnload: function confirmUnsavedChangesOnUnload() {
                    ...
                    formatPosition: function formatPosition(number) {
                    ...
                    getOrCreateElmtId: function getOrCreateElmtId(elmt) {
                        var id = elmt.attr('id');
                        if (!id) {
                    ...
                    tabFromHash: function tabFromHash() {
                                ...
                                if ($('.toast-tabs').parent().parent().hasClass('toast-tab-collapse')) {
                                    ...
                                    if (activeTab.size() > 0) {
                                        ...
                                        $('.toast-tab-wrapper').animate({
                                            scrollLeft: Math.max(0, Math.min(tabsWidth - wrapperWidth, activeTab.position().left - wrapperWidth / 2 + activeTab.width() / 2))
                                        });
                                    }
                                } else {
                    ...
                    arrayToJqueryParams: function arrayToJqueryParams(paramName, values) {
                    ...
                    findMultieditSelected: function findMultieditSelected(table) {
                        return table.find(':checkbox:checked:not(:disabled):not([data-multiedit-master])');
                    },
                    enableMultiedit: function enableMultiedit(wrapperId, onChange) {
                        var tableId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
                    ...
                    updateCheckboxContainerStyle: function updateCheckboxContainerStyle(checkbox) {
                    ...
                    updateSelectionListState: function updateSelectionListState($list) {
                        var disabledProp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'disabled';
                    ...
                    enableSelectionList: function enableSelectionList(rootElmt) {
                        var disabledProp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'disabled';
                    ...
                    positionAtBottom: function positionAtBottom(elmt, force) {
                        var win = $(window);
                        var viewport = {
                            top: win.scrollTop(),
                            left: win.scrollLeft()
                    ...
                    enablePrettyUploads: function enablePrettyUploads() {
                        ...
                        filePickers.closest('.image-selection').find('.remove-image-undo').click(function(e) {
                            e.preventDefault();
                            $(this).parent().hide().prev().prop('disabled', false).prev().val('false').prev().show().parent().find('img').removeClass('opacity30');
                        });

                        if ($.browser !== undefined && $.browser.mozilla !== undefined && $.browser.mozilla) {
                            //null checks with compatiability for angular material
                    ...
                    addSectionEnabler: function addSectionEnabler(checkboxId, sectionId, invert, slide) {
                    ...
                    addTouchSectionEnabler: function addTouchSectionEnabler(touchElmtPrefix, sectionId, invert, slide, callback) {
                    ...
                    addTouchSectionDisabler: function addTouchSectionDisabler(touchElmtPrefix, sectionId, invert, callback) {
                    ...
                    _deleteEntityTableRow: function _deleteEntityTableRow(row, explicitdelete) {
                    ...
                    _undeleteEntityTableRow: function _undeleteEntityTableRow(row, explicitdelete) {
                     ...
                     */
                    enableEntityTableDelete: function enableEntityTableDelete(entityTable, callback, explicitdelete) {
                        // delete entity
                    ...
                    enableEntityTableRowTemplate: function enableEntityTableRowTemplate(button, entityTable, beforeShow, afterShow) {
                    ...
                    enableEntityTableInput: function enableEntityTableInput(el, moveWithEnterKey) {
                    ...
                    enableTreePickerForCell: function enableTreePickerForCell(cell, isTarget) {
                    ...
                    enableSelectPickerTemplate: function enableSelectPickerTemplate(el, changeFunction) {
                    ...
                    enableEntityTableSelect: function enableEntityTableSelect(el) {
                    ...
                    _initializeTreePickerTemplate: function _initializeTreePickerTemplate(el) {
                    ...
                    _initializeSelectPickerTemplate: function _initializeSelectPickerTemplate(el, changeFunction) {
                    ...
                    _selectpickerAndOpen: function _selectpickerAndOpen(select, options, cssClass, buttonCssClass) {
                    ...
                    enableEntityTableEditLink: function enableEntityTableEditLink(el) {
                        // Editable links
                        var showEditIcon = function showEditIcon(td) {
                            var tr = td.closest('tr');
                            if (td.attr('editing') != 'true' && !tr.hasClass('deleted') && !tr.hasClass('readonly')) {
                                td.find('.input-edit').show();
                            }
                        };
                        var hideEditIcon = function hideEditIcon(td) {
                    ...
                    enableEditButton: function enableEditButton(entityTable, editButton) {
                        if (editButton) {
                    ...
                    _reorderFormCollection: function _reorderFormCollection(entityTable, childEntityPrefix) {
                    ...
                    enableChildEntityTable: function enableChildEntityTable(entityTable, childEntityPrefix, editButton, _onDrop, onDelete, explicitdelete) {
                    ...
                    enableChildEntityTableOrderColumn: function enableChildEntityTableOrderColumn(entityTable, childEntityPrefix, editButton, onChange, onDelete, explicitdelete) {
                        Toast.enableEntityTableDelete(entityTable, onDelete, explicitdelete);
                        Toast.enableEditButton(entityTable, editButton);
                    ...
                    enableChildEntityAlphabeticalSort: function enableChildEntityAlphabeticalSort(entityTable, paramPrefix, paramName, alphabetizeButton) {
                    ...
                    updateOrderColumn: function updateOrderColumn(tr) {
                    ...
                    _updateLinkedTreepicker: function _updateLinkedTreepicker(treepicker, selectedIds, targetInput, ownerInput) {
                    ...
                    updateEditColumns: function updateEditColumns(entityTable) {
                        if (entityTable.data('editing')) {
                    ...
                    initTableDefaultSelection: function initTableDefaultSelection(tables, multiselect, required, checkboxSelector) {
                        // TODO: allow multi-select for checkboxes that have the same master

                        checkboxSelector = checkboxSelector || '.td-checkbox :checkbox';

                        var updateCheckedStates = function updateCheckedStates() {
                    ...
                    initCheckboxes: function initCheckboxes(checkboxLabels) {
                    ...
                    strContains: function strContains(value, query) {
                        var result = value && ~value.toLowerCase().indexOf(query);
                        return result;
                    },

                    strStartsWith: function strStartsWith(value, query) {
                    ...
                    chooseEntity: function chooseEntity(entityType, entity, searchText, previewText, listAction, constructItem, previewUrl, previewDataUrl, copy, successCallback, searchFn, multiselect) {
                        ...
                        modal.find('.help-text p').html('Selecting Deep Copy will create a copy of the selected ' + entity + ' and any items, subgroups, modifier groups, ' + 'and modifiers it contains. Any changes made to these copies will not impact the originals.');
                        ...
                        function showEntities(data) {
                            ...
                            function showEntityPreview(elmt, doSelect) {
                                ...
                                if (previewUrl) {
                                    ...
                                    modal.find('.entity-preview').empty().addClass('loading').show().load(url, function() {
                        ...
                        var resizeEntityChooserOnWindowResize = function resizeEntityChooserOnWindowResize() {
                    ...
                    trimKeepalivePrefix: function trimKeepalivePrefix(text) {
                        // trim off any leading dots from our Heroku timeout avoiding code
                        return text.replace(/^[\.=]+/, '');
                    },

                    ajaxKeepAliveJson: function ajaxKeepAliveJson(fn, url, data, callback) {
                    ...
                    getKeepAliveJson: function getKeepAliveJson(url, data, callback) {
                        Toast.ajaxKeepAliveJson($.get, url, data, callback);
                    },

                    postKeepAliveJson: function postKeepAliveJson(url, data, callback) {
                        Toast.ajaxKeepAliveJson($.post, url, data, callback);
                    },

                    formatting: {
                        formatCommas: function formatCommas(num) {
                            return num.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
                        }
                    },

                    // Asynchronously load restaurants into each picker in 'pickers'
                    loadRestaurantPickers: function loadRestaurantPickers(pickers, selected, shardGuid, useExisting, callback) {
                        var html = '';
                    ...
                    renderRestaurantPickers: function renderRestaurantPickers(pickers, html) {
                        pickers.prop('disabled', false).html(html).addClass('loaded').find('.loading-placeholder').remove();
                    },

                    init: function init(imageRoot, staticResRoot) {
            ...
            Toast.alertMgr = function() {
                ...
                function _message(msg, cssClasses, container) {
                    var notifications = container || getContainer();
                    var alert = $('<div class="alert"><a class="close" data-dismiss="alert">×</a>' + msg + '</div>').addClass(cssClasses);
                    notifications.append(alert);
                    notifications.show();
                }

                return {
                    message: function message(msg, cssClasses, container) {
                        _message(msg, cssClasses, container);
                    },
                    error: function error(msg, container) {
                        _message(msg, 'alert-error', container);
                    },
                    success: function success(msg, container) {
                        _message(msg, 'alert-success', container);
                    },
                    info: function info(msg, container) {
                        _message(msg, 'alert-info', container);
                    },
                    warning: function warning(msg, container) {
                        _message(msg, '', container);
                    },
            ...
            Toast.reporting = function() {
                ...
                var TIME_RANGE_ALL_HOURS = '-2';
                var TIME_RANGE_CUSTOM_HOURS = '-1';
                ...
                function getCurrentFilterState() {
                    ...
                    var restaurantIds = $('#allrestaurants-dropdown-container ul.dropdown-menu li.selected[data-is-leaf="true"]').map(function(i, e) {
                        return e.dataset.val;
                    });
                    var uniqueIds = [].concat(_toConsumableArray(new Set(restaurantIds.toArray())));
                ...
                var moreFilterIds = ['#more-dropdown-container', '#dining-option-option', '#discount-option', '#revenue-center-option', '#scheduled-option', '#service-area-option', '#service-option', '#source-option', '#state-option', '#tax-exempt-option', '#voided-option'];
                ...
                var asyncReportHandlers = {
                    download: {
                        ...
                        success: function success(data, request) {
                            $('<iframe/>').attr({
                        ...
                        progress: function progress(_progress, request) {
                            if (request.passthroughs && request.passthroughs.link) {
                                var link = request.passthroughs.link;
                                var label = link.prev();
                                ...
                                var written = Toast.formatting.formatCommas(_progress);
                                label.show().find('span').text(written);
                            }
                        },
                        error: function error(msg, request) {
                            cleanupAsyncDownload(request);
                            alert(msg, request);
                        }
                    }
                ...
                function dataTableInit() {
                    ...
                    var turnTimeFmtToSeconds = function turnTimeFmtToSeconds(s) {
                    ...
                    var basicSort = function basicSort(s1, s2, transform) {
                        var x = transform(s1),
                            y = transform(s2);
                ...
                function reportOptionsInit() {
                    ...
                    if (button.length > 0 && button.find('.selected-label').length > 0 && button.find('#report-restaurants').length > 0 && button.find('.selected-label')[0].innerHTML !== button.find('#report-restaurants')[0].getAttribute('value')) {
                    ...
                    var markDatePickerDirty = function markDatePickerDirty(e) {
                    ...
                    refreshReportExecutionMetadata(function(metadata) {
                        ...
                        if (loadUrl && !metadata.errorMsg && (!tab.data('loaded') || tab.data('dirty'))) {
                            ...
                            if (metadata.enableWeb) {
                                var onSuccess = function onSuccess(html) {
                                    tabPane.html(html);
                ...
                return {
                    init: function init(startReportUrl, options) {
                        reportOptionsInit();
                        dataTableInit();
                        loadReport(startReportUrl + '?reportHtml=true', options);
                    },
                    highlightUpdateBtn: function highlightUpdateBtn() {
                        $('#update-btn,#adhoc-export-btn').addClass('dropdown-non-default').removeClass('btn-default');
                    },
                    reloadReport: function reloadReport() {
                        reloadCurrentReport();
                    },
                    exposeEmailExport: function exposeEmailExport(showAdhocButton, adhocExportUrl) {
                        toggleAdhocExportBtn(showAdhocButton, adhocExportUrl);
                    },
                    refreshExecutionMetaData: function refreshExecutionMetaData(callback) {
                        refreshReportExecutionMetadata(callback);
                    },
                    reloadReportTab: function reloadReportTab(tabId, show) {
                    ...
                    loadHtmlAsyncReport: function loadHtmlAsyncReport(url, containerId, _success, _error) {
                    ...
                    loadAsyncReportDataHandler: function loadAsyncReportDataHandler(url, data, targetSpec, handler, passthroughs) {
                        loadAsyncReportData(url, data, targetSpec, handler, passthroughs);
                    },
                    makeExportAsync: function makeExportAsync(linkId) {
                    ...
                    asyncFormExportSubmit: function asyncFormExportSubmit(form, onSuccess) {
                        var handler = asyncReportHandlers.download;
                    ...
                    updateCustomTimeOptions: function updateCustomTimeOptions(timeRangeBtn) {
                        if (timeRangeBtn.attr('data-value') === TIME_RANGE_CUSTOM_HOURS) {
                    ...
                    augmentDOMTable: function augmentDOMTable(tableId, options) {
                        var columnSelector = options.noColumnSelector ? '' : '<"column-selector"C>';
                    ...
                    drawChart: function drawChart(drawFn) {
                    ...
                    parseChartTimeSeries: function parseChartTimeSeries(rawTimeSeries, columns) {
                        if (!rawTimeSeries) {
                            return [];
                        }
                    ...
                    googleChartsCallback: function googleChartsCallback() {
                        googleChartsLoaded = true;
                    },
                    setReportRestaurant: function setReportRestaurant(leafSetId) {
                    ...
                    // dates in MM-dd-yyyy
                    setReportDates: function setReportDates(startDateText, endDateText) {
                        var reportOptions = $('.report-options');
                    ...
                    loadNoInitialLoadTab: function loadNoInitialLoadTab(container, url, tabName) {
                        container.addClass('loading');
                        container.mask('Loading...');
                    ...
                    updateDisplayedDates: function updateDisplayedDates(startDateText, endDateText, isCustom) {
                    ...
                    augmentReportUrlWithFilters: function augmentReportUrlWithFilters(url) {
                        return augmentReportLoadUrl(url);
                    },
                    floatingHeader: function floatingHeader(tableID) {
                        ...
                        var isShowHeader = function isShowHeader() {
                            var tableWidth = $('#' + tableID).width();
                            var windowWidth = window.innerWidth > 0 ? window.innerWidth : screen.width;
                            return tableWidth <= windowWidth;
                        };

                        var getHeaderTop = function getHeaderTop() {
            ...
            Toast.reporting.labor = function() {
                ...
                return {
                    ...
                    showEditTimeEntryDialog: function showEditTimeEntryDialog(timeEntryId) {
                        showTimeEntryDialog(timeEntryId, null);
                    },
                    showNewTimeEntryDialog: function showNewTimeEntryDialog(rId, rUserId) {
                        showTimeEntryDialog(null, rUserId, rId);
                    },
                    showEditTimeEntryBreakDialog: function showEditTimeEntryBreakDialog(timeEntryId, timeEntryBreakId) {
            ...
            Toast.auditing = function() {
                ...
                return {
                    init: function init(rId, url) {
                        Toast.editorCommon.init();
                        toastAuditingUrl = url;
                    },
                    submit: function submit(isOrdersType) {
            ...
            Toast.deliveryConfig = function() {
                ...
                return {
                    init: function init(APIKey, _useMapbox) {
                        ...
                        // Checkin Preview
                        var $inputBox = $('#curbsideArrivalConfig_checkInMessage');
                        var spaPreview = $('#curbside-spa-message');
                        var $useCustomCheckinMessage = $('#curbsideArrivalConfig_checkInMessageEnabled_true');
                        var $useStandardCheckinMessage = $('#curbsideArrivalConfig_checkInMessageEnabled_false');
                        var useCustomCheckinMessage = $useCustomCheckinMessage.is(':checked');
                        var defaultValue = $inputBox.prop('placeholder');
                        ...
                        // Custom sms
                        var useLink = void 0;
                        var customSMSEnabled = void 0;
                        var defaultSMS = void 0;

                        var $messagePreview = $('#messagePreview');
                        var $smsInputBox = $('#curbsideArrivalConfig_customSMS');
                        var $enableLinkCheckbox = $('#curbsideArrivalConfig_includeLinkInSMS_true');
                        var $useCustomSMSCheckboxCustom = $('#curbsideArrivalConfig_customSMSEnabled_true');
                        var $useCustomSMSCheckboxStandard = $('#curbsideArrivalConfig_customSMSEnabled_false');
                ...
                function drawPolygonMapbox(encoded) {
                    var coordinatesArray = polyline.decode(encoded);
                    ...
                    coordinatesArray.forEach(function(e) {
                        return e.reverse();
                    });
                ...
                function markLatLngMapbox(lat, lng, center, marker) {
                    ...
                    if (marker) {
                        ...
                        centerMarker = new mapboxgl.Marker(el).setLngLat(coordinate).addTo(map);
                    }
                }
                ...
                function centerMapMapbox(address) {
                    var urlEncodedAddress = encodeURI(address);
                    var url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + urlEncodedAddress + '.json';
                    $.ajax({
                        dataType: 'json',
                        url: url,
                        data: {
                            ...
                            if (results.length > 0) {
                                if (map) {
                                    ...
                                    if (centerMarker) {
                                        ...
                                        centerMarker = new mapboxgl.Marker(el).setLngLat([results[0].center[0], results[0].center[1]]).addTo(map);
                                    }
                                }
                            } else {
                ...
                function encodeAndStorePolygonPath(features) {
                    ...
                    features.geometry.coordinates[0].forEach(function(e) {
                        return lngLatArray.push(e);
                    });

                    var coordinatesArray = lngLatArray.map(function(e) {
                        return [e[0], e[1]].reverse();
                    });

                    var encodedPolygon = polyline.encode(coordinatesArray);
                ...
                function restrictUserFromDrawingMultiplePolygons(e) {
                    ...
                    if (draw.getMode() == 'draw_polygon') {
                        ...
                        var lid = data.features[data.features.length - 1].id;
                ...
                function restrictUserFromMovingPolygon(e) {
                    ...
                    var hasLine = features && features.length > 0;
                ...
                return {
                    init: function init() {
                        ...
                        $('#approval-mode-selection input').click(function() {
                            $('#approval-mode-rules-config').toggle(this.value === 'RULES' && this.checked);
            ...
            Toast.masterEditorCommon = function() {
                ...
                return {
                    addColSerializationFn: function addColSerializationFn(name, fn) {
                        colSerializationFns[name] = fn;
                    },
                    enableEntityActions: function enableEntityActions(el) {
                        ...
                        el.find('a.version-entity').click(function(e) {
                            ...
                            $.each(targets, function() {
                                targetTreepicker.find('li[data-val=' + $(this).val() + ']').addClass('disabled');
                            });
            ...
            Toast.masterDetail = function() {
                return {
                    init: function init(dialog, refreshPage) {
                    ...
                    enableNewVersionDetailDialog: function enableNewVersionDetailDialog(entityName, entityId) {
                        var html = $('<div style="font-weight:bold;"></div>');
                        html.append(entityName);
                        $('.entity-info').html(html);
                        $('.entity-id').val(entityId);
                    },
                    enableDeletion: function enableDeletion(deleteUrl, undeleteUrl, entityType, entityId, addToType, addToId) {
                    ...
                    renderReadonly: function renderReadonly() {
                        ...
                        $('.child-entity-table tr:not(.exclude-from-readonly,.template)').addClass('readonly').find('button:not(.exclude-from-readonly),input:not([type="hidden"], .exclude-from-readonly)').prop('disabled', true);
                        ...
                        $('div.control-group .controls ul,ul.selection-list,input:not([type="hidden"],.search-query,.exclude-from-readonly),textarea:not(.exclude-from-readonly),select:not(.exclude-from-readonly)').addClass('disabled').prop('disabled', true).css('cursor', 'default');

                        $('div.control-group .controls ul.selection-list > li > label').css('cursor', 'default');

                        $('.td-checkbox input:not([type="hidden"],.exclude-from-readonly)').addClass('disabled').prop('disabled', true).css('cursor', 'default');
                        ...
                        $('div.color-editor .pos-cell').addClass('disabled').click(function(e) {
                            e.stopImmediatePropagation();
                        });
                    }
                };
            ...
            Toast.menuMgmt = function() {
                ...
                return {
                    ...
                    setupInheritedSection: function setupInheritedSection(touchElmtPrefix, sectionId) {
                    ...
                    chooseMenuGroup: function chooseMenuGroup(multiselect, parentSetId, copy, success) {
                        ...
                        var constructEntry = function constructEntry(group) {
                        ...
                        var searchFn = function searchFn(entity, query) {
                    ...
                    chooseMenuOption: function chooseMenuOption(multiselect, optionGroupId, parentSetId, copy, success) {
                        ...
                        var constructEntry = function constructEntry(option) {
                    ...
                    parseBulkMenuItems: function parseBulkMenuItems(inputString, numColumns) {
                    ...
                    showAddItemBulkDialog: function showAddItemBulkDialog(title, description, placeholder, numColumns, onAddHandler) {
                    ...
                    chooseMenuItem: function chooseMenuItem(multiselect, groupid, parentSetId, copy, success) {
                        ...
                        var constructEntry = function constructEntry(item) {
                    ...
                    chooseOptionGroup: function chooseOptionGroup(multiselect, parentSetId, copy, success) {
                    ...
                    chooseMenuItemTag: function chooseMenuItemTag(multiselect, parentSetId, copy, success) {
                        ...
                        var constructEntry = function constructEntry(tag) {
                    ...
                    chooseServiceCharge: function chooseServiceCharge(success) {
                        ...
                        var constructEntry = function constructEntry(serviceCharge) {
                    ...
                    initGroupsEditor: function initGroupsEditor(paramName) {
                        ...
                        $('.admin-content').on('click', '.add-group-existing', function(e) {
                            ...
                            Toast.menuMgmt.chooseMenuGroup(true, $(this).attr('data-parent-set-id'), true, function(groups, deepCopy) {
                                ...
                                $.each(groups, function(i, group) {
                                    ...
                                    row.append(Toast.editorCommon.createInputLink(paramPrefix + '.copyName', 'Name', group.name, group.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(group.id)).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.copy').val('true')).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.deepCopy').val(deepCopy || false)));
                                    row.append($('<td class="td-actions edit-column"></td>').append('<a class="remove-entity"><i class="icon-trash opacity70" title="Remove group"></i></a>').append('<a class="undo">undo remove</a>'));
                    ...
                    initOptionGroupsEditor: function initOptionGroupsEditor(itemParam) {
                        ...
                        var updateMaxSelections = function updateMaxSelections(el) {
                            ...
                            return function(e) {
                                ...
                                Toast.menuMgmt.chooseOptionGroup(true, $(this).attr('data-parent-set-id'), copy, function(optionGroups, deepCopy) {
                                    ...
                                    $.each(optionGroups, function(i, optionGroup) {
                                        ...
                                        var paramPrefix = paramName + '[' + nextRowIdx + ']';
                                        if (copy) {
                                            row.append(Toast.editorCommon.createInputLink(paramPrefix + '.copyName', 'Name', optionGroup.name, optionGroup.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(optionGroup.id)).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.copy').val('true')).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.deepCopy').val(deepCopy || false)));
                                        } else {
                                            row.append(Toast.editorCommon.createInputLink(paramPrefix + '.name', 'Name', optionGroup.name, optionGroup.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(optionGroup.id)));
                                        }
                                        ...
                                        if (optionGroup.minSelections) {
                                            row.append($('<td>' + '<div class="min-selections" ' + (optionGroup.multiSelect ? '' : 'style="display:none;"') + '>' + optionGroup.minSelections + '</div>' + '<div class="min-selections-na" ' + (optionGroup.multiSelect ? 'style="display:none;"' : '') + '>n/a</div>' + '</td>'));
                                        }
                                        row.append($('<td>' + '<div class="max-selections" ' + (optionGroup.multiSelect ? '' : 'style="display:none;"') + '>' + optionGroup.maxSelections + '</div>' + '<div class="max-selections-na" ' + (optionGroup.multiSelect ? 'style="display:none;"' : '') + '>n/a</div>' + '</td>'));
                    ...
                    initTagsEditor: function initTagsEditor(paramName) {
                        // add existing tag
            ...
            Toast.menuMgmt.menuItem = function() {
                ...
                return {
                    ...
                    setupModifierTaxHandler: function setupModifierTaxHandler(itemParam) {
                        var modifierTaxBehavior = {
                            selectionList: $("#" + itemParam + "_modifierTaxBehaviorEnum"),
                            inputSelector: "input[name='" + itemParam + ".modifierTaxBehaviorEnum']"
                        };

                        var inheritsTaxRates = {
                        ...
                        function enable(item) {
                            var list = item.selectionList;
                            var inputSelector = item.inputSelector;
                        ...
                        function evaluateTaxStrategies() {
                            var doesItemInheritTaxes = $("#item_inheritTaxRates_true").is(':checked');
                            var doModifiersInheritTaxRateBehavior = $("#item_modifierTaxBehaviorEnum_INHERITS_PARENT_TAX").is(":checked");
            ...
            Toast.menuMgmt.group = function() {
                return {
                    init: function init(groupId, groupPriceRange, parentGroupPriceRange, currencySymbol) {
                        Toast.menuMgmt.init();
                            ...
                            return function(e) {
                                ...
                                Toast.menuMgmt.chooseMenuItem(true, groupId, $(this).attr('data-parent-set-id'), copy, function(items, deepCopy) {
                                    $.each(items, function(i, item) {
                                        ...
                                        if (copy) {
                                            row.append(Toast.editorCommon.createInputLink(paramPrefix + '.copyName', 'Name', item.name, item.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(item.id)).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.copy').val('true')).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.deepCopy').val(deepCopy || false)));
                                        } else {
                                            row.append(Toast.editorCommon.createInputLink(paramPrefix + '.name', 'Name', item.name, item.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(item.id)));
                                        }
                                        ...
                                        if (pricingInfo.basePrice != null) {
                                            if (copy) {
                                                itemPriceCell.append($('<input type="hidden">').attr('name', paramPrefix + '.copyBasePrice').attr('value', pricingInfo.basePrice));
                                            } else {
                                                itemPriceCell.append($('<input type="hidden">').attr('name', paramPrefix + '.basePrice').attr('value', pricingInfo.basePrice));
                                            }
                                        } else {
                                            if (copy) {
                                                itemPriceCell.append($('<input type="hidden">').attr('name', paramPrefix + '.copyBasePrice').attr('value', null));
                                            } else {
                                                itemPriceCell.append($('<input type="hidden">').attr('name', paramPrefix + '.basePrice').attr('value', null));
                                            }
                                        }
                                        ...
                                        row.append($('<td class="edit-column"></td>').append('<a class="remove-entity"><i class="icon-trash opacity70" title="Remove item"></i></a>').append('<a class="undo">&{"field.table.undoremove"}</a>'));
                        ...
                        $('.admin-content').on('click', '.add-item-bulk', function(e) {
                            ...
                            Toast.menuMgmt.showAddItemBulkDialog('Bulk Add Items', 'Please paste in from a spreadsheet: Name, Price, POS Name, Kitchen Name, Description, Calories, SKU, PLU', 'Name  Price  POS Name  Kitchen Name  Description  Calories  SKU  PLU', null, function(items) {
                                if (items.length > 0) {
                                    ...
                                    for (var menuItemIdx in items) {
                                        ...
                                        if (values.length >= 10) {
                                            ...
                                            while (values[index] && values[index] != '') {
                                                itemsTable.find('tbody tr:not(.placeholder,.template):last').append($('<input type="hidden" name="group.items[' + itemIdx + '].newSizeOption[' + sizeOptionIdx + '].name" value="' + values[index++] + '" />')).append($('<input type="hidden" name="group.items[' + itemIdx + '].newSizeOption[' + sizeOptionIdx++ + '].price" value="' + values[index++] + '" />'));
                                                if (priceLow == null) {
            ...
            Toast.menuMgmt.optionGroup = function() {
                return {
                    updatePriceColumns: function updatePriceColumns(pricingMode) {
                        if (!pricingMode) {
                    ...
                    init: function init(optionGroupId) {
                        ...
                        var chooseMenuOption = function chooseMenuOption(copy, optionGroupId, parentSetId) {
                            Toast.menuMgmt.chooseMenuOption(true, optionGroupId, parentSetId, copy, function(options, deepCopy) {
                                ...
                                $.each(options, function(i, option) {
                                    ...
                                    if (copy) {
                                        ...
                                        row.append(Toast.editorCommon.createInputLink(nameField, namePlaceholder, option.name, option.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(option.id)).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.copy').val('true')).append($('<input type="hidden"></input>').attr('name', paramPrefix + '.deepCopy').val(deepCopy || false)));
                                    } else {
                                        row.append(Toast.editorCommon.createInputLink(nameField, namePlaceholder, option.name, option.url).append($('<input type="hidden" class="id-param"></input>').attr('name', paramPrefix + '.id').val(option.id)));
                                        priceField = paramPrefix + (overridePrice ? '.overriddenPrice' : '.itemPrice');
                                    }

                                    if (overridePrice || priceRaw) {
                                        row.append($('<td class="currency price-column"></td>').text('$')).append($('<td class="td-input right price-column"></td>').append($('<input type="text" placeholder="0.00" />').attr('name', priceField).val(priceRaw)));
                                    } else {
                                    ...
                                    row.append($('<td class="td-actions edit-column"></td>').append('<a class="remove-entity"><i class="icon-trash opacity70" title="Remove option"></i></a>').append('<a class="undo">undo remove</a>'));
                    ...
                    init: function init() {
                        ...
                        $('#item-preview-toggle').click(function() {
                            ...
                            if (!toggle.data('loaded')) {
                                ...
                                toggle.next().find('> img').hide().end().find('.entity-preview').load(Toast.menuMgmt.baseUrl + '/menuItemPreview?id=' + toggle.attr('data-item-id'));
                            }
                        });
                    }
                };
            ...
            Toast.menuMgmt.pricing = function() {
                return {
                    ...
                    updateItemGroupPrices: function updateItemGroupPrices(pricingMode, pricingStrategy) {
                        if (!pricingMode) {
                    ...
                    enablePriceWatching: function enablePriceWatching() {
                        var me = Toast.menuMgmt.pricing;
                    ...
                    initGroup: function initGroup(itemParam, currencySymbol, groupPriceRange, parentGroupPriceRange) {
                        var me = Toast.menuMgmt.pricing;
            ...
            Toast.moveCards = function() {
                return {
                    init: function init(currentShardId) {
                        Toast.editorCommon.init();
                        ...
                        searchInput.typeahead({
                            ...
                            updater: function updater(item) {
                                ...
                                var html = '<div class="caption"><h3>' + item.name + '</h3>' + '<p><b>Restaurant id: </b>' + item.id + '</p>' + '<p><b>Restaurant guid: </b>' + item.guid + '</p>' + '<input type="hidden" name="sourceRestaurantId" value="' + item.id + '"/></div>';
                    ...
                    init: function init() {
                        ...
                        searchInput.typeahead({
                            ...
                            updater: function updater(item) {
                                ...
                                newRow.find('#upsell-id').attr('name', paramPrefix + '.id').val('true');
                                newRow.find('#upsell-item-id').attr('name', paramPrefix + '.' + itemPrefix + '.id').val(Toast.escapeHtml(item.itemId));

                                newRow.find('#upsell-group-id').attr('name', paramPrefix + '.' + groupPrefix + '.id').val(Toast.escapeHtml(item.groupId));
            ...
            Toast.guestFeedbackConfig = function() {
                ...
                return {
                    ...
                    init: function init() {
                        ...
                        var enableUserSelection = function enableUserSelection(el) {
                        ...
                        var enableAlertTypeInput = function enableAlertTypeInput(el) {
            ...
            Toast.editorCommon = function() {
                return {
                    ...
                    updateCheckboxes: function updateCheckboxes(el) {
                    ...
                    updateCheckbox: function updateCheckbox(checkbox) {
                        if (checkbox.checked) {
                    ...
                    createCheckbox: function createCheckbox(name, value) {
                        var checkbox = $('<input type="checkbox" name="' + name + '"/>').val(true);
                        if (value) {
                            checkbox.attr('checked', 'checked');
                        }
                        return $('<td class="td-checkbox"></td>').append($('<label></label>').append(checkbox).append('<input type="hidden" name="' + name + '" value="false" />'));
                    },
                    createSelect: function createSelect(name, value, choices) {
                        ...
                        return $('<td class="td-select"></td>').append(select);
                    },
                    createInputLink: function createInputLink(nameField, namePlaceholder, name, url) {
                        return $('<td class="td-input-link"></td>').append($('<div></div>').append($('<a class="input-link"></a>').text(name).attr('href', url)).append($('<a class="input-edit" href="#" style="display:none;"><i class="icon-edit"></i></a>')).append($('<input type="text" placeholder="' + namePlaceholder + '" style="display:none;" class="input-param"></input>').attr('name', nameField).val(name)));
                    },

                    closeColorChoices: function closeColorChoices(wrapper) {
                    ...
                    setPressState: function setPressState(wrapper) {
                    ...
                    enableColorEditor: function enableColorEditor(wrapper) {
                        ...
                        var setupColorChoiceEvents = function setupColorChoiceEvents() {
                            ...
                            wrapper.find('.popover .pos-cell').click(function() {
                                ...
                                currentChoice.css('backgroundColor', $(this).css('backgroundColor')).popover('hide');
                    ...
                    enableHexInputColorEditor: function enableHexInputColorEditor(wrapper) {
                        if (wrapper.hasClass('disabled')) {
                            return;
                        }
                        ...
                        var isValidInput = function isValidInput(string) {
                        ...
                        var getFormattedColor = function getFormattedColor(hexString) {
                            return '#' + hexString.slice(-6);
                        };

                        var setChosenColor = function setChosenColor(color) {
                            var formattedColor = getFormattedColor(color);
                            currentChoice.css('backgroundColor', formattedColor).popover('hide');
                    ...
                    enableSaveAndPublishBtns: function enableSaveAndPublishBtns(confirmFunction) {
                    ...
                    disableSaveAndPublishBtns: function disableSaveAndPublishBtns() {
                        $('#save-btn,#save-and-add-btn,#publish-btn').addClass('disabled');
                    },
                    init: function init(confirmFunction) {
            ...
            Toast.printing = function() {
                ...
                return {
                    initReceiptConfig: function initReceiptConfig(lineMaxChars) {
                        Toast.editorCommon.init();
                    ...
                    initPrinter: function initPrinter() {
                        if ($('#printer_cashDrawer_resetType_MANUAL').prop('checked') == false && $('#printer_cashDrawer_resetType_AUTOMATIC').prop('checked') == false) {
                            $('#printer_cashDrawer_resetType_AUTOMATIC').prop('checked', true);
                            $('#printer_cashDrawer_balance').prop('value', '0.00');
                        }

                        if ($('#printer_secondaryCashDrawer_resetType_MANUAL').prop('checked') == false && $('#printer_secondaryCashDrawer_resetType_AUTOMATIC').prop('checked') == false) {
                    ...
                    initFixedSizeReceiptLinesEditor: function initFixedSizeReceiptLinesEditor(rows, cols) {
                        /**
                        ...
                        $('#printer_customItemLabelFooter').on('keyup', function(e) {
                            ...
                            var linesByNewLine = textValue.split('\n');
                            var receiptLines = [];
                            for (var j = 0; j < linesByNewLine.length; j++) {
                                var line = breakWords(linesByNewLine[j]);
                                var lineSplitBy42Chars = splitBy42Chars(linesByNewLine, line, j);
                                receiptLines = receiptLines.concat(lineSplitBy42Chars);
                            }
                            var newText = receiptLines.join('');
                        ...
                        var keysThatAddCharacters = ['Enter', 'Tab', ' ', 'Spacebar', 'Divide', 'Add', 'Multiply', 'Decimal', 'Subtract', '`', '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '-', '+', '=', '[', '{', ']', '}', '|', '\\', ';', ':', '\'', '"', ',', '<', '>', '/', '?', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0'];

                        function allowedToAddCharacter(e) {
                            var position = e.target.selectionStart;
                            var value = e.target.value;
                            var receiptLines = getReceiptLines(value);
                            var canAddLine = receiptLines.length < rows;
                            if (canAddLine) {
                                return true;
                            }
                            var currentIndex = 0;
                        ...
                        function splitBy42Chars(splitByNewLines, curLine, index) {
                            var re = new RegExp('.{1,' + cols + '}', 'g');
                            var splitCurLine = curLine.match(re) || curLine;
                        ...
                        function getReceiptLines(string) {
                            ...
                            var splitByNewLines = string.split('\n');
                            var lines = [];
                            for (var i = 0; i < splitByNewLines.length; i++) {
                                var curLine = splitByNewLines[i];
                                var lineSplitBy42Chars = splitBy42Chars(splitByNewLines, curLine, i);
                        ...
                        function allowedToAddNewLine(e) {
                            var receiptLines = getReceiptLines(e.target.value);
                            return receiptLines.length < rows;
                        }

                        function breakWords(text) {
                            var groupsOf42 = Math.ceil(text.length / cols);
                            for (var k = 0; k < groupsOf42; k++) {
                                var max = (k + 1) * cols;
                                if (text.length > max) {
                                    if (text[max - 1] !== ' ' && text[max - 1] !== '-') {
                                        // at the 42nd position, is there already a break character?
            ...
            Toast.jobs = function() {
                ...
                return {
                    ...
                    initEdit: function initEdit(detectWageChange) {
                        Toast.editorCommon.init();
                    ...
                    initQuickAdd: function initQuickAdd() {
                        Toast.editorCommon.init();
            ...
            Toast.users = function() {
                ...
                return {
                    ...
                    initEdit: function initEdit(showConfirm) {
            ...
            Toast.checkSearch = {
                ...
                processSearch: function processSearch(url, data, callback) {
            ...
            Toast.receiptOptions = {
                setupReceiptOptionsDialog: function setupReceiptOptionsDialog(container) {
            ...
            Toast.cashDrawerReport = {
                load: function load(selectedDrawerId) {
            ...
            Toast.archiveOrders = function() {
                ...
                function confirmArchive() {
                    ...
                    loading.show();
                    content.empty();
                    content.load(Toast.archiveOrders.confirmUrl, selectedIdsToParam(), function(response, status) {
                        if (status === 'success') {
                            loading.hide();
                            // Adjust the size of the dialog
                ...
                return {
                    selectedOrders: {},
                    init: function init(oTable, archiveUrl, archiveConfirmUrl) {
                    ...
                    renderCheckbox: function renderCheckbox(oObj) {
                        var id = oObj.aData[0];
            ...
            Toast.toastPromotions = function() {
                return {
                    bootstrapConfigSaveButton: function bootstrapConfigSaveButton() {
            ...
            Toast.paymentsMgr = function() {
                ...
                function setupRefundForm() {
                    var isRefundReasonsFlagEnabled = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
                    var hasRefundReasonsConfigured = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
                    ...
                    if (isRefundReasonsFlagEnabled) {
                        Toast.enableSelectPickerTemplate(form, function() {
                            return validateRefundReasonSelected();
                        });
                    }
                ...
                return {
                    initRefund: function initRefund(isRefundReasonsFlagEnabled, hasRefundReasonsConfigured) {
                        setupRefundForm(isRefundReasonsFlagEnabled, hasRefundReasonsConfigured);
                    },

                    initRefundReceipt: function initRefundReceipt() {
                        Toast.receiptOptions.setupReceiptOptionsDialog($('#refund-email-options'));
                    },

                    initTipAdjustment: function initTipAdjustment() {
                        setupTipAdjustmentForm();
                    },

                    initVoidReversal: function initVoidReversal() {
            ...
            Toast.orderDetail = function() {
                var reloadOrdersReport = function reloadOrdersReport() {
                ...
                var findOrCreateNotifications = function findOrCreateNotifications(container) {
                ...
                var changeGuestNum = function changeGuestNum(container, staticResRoot) {
                ...
                var changeRevenueCenter = function changeRevenueCenter(container, staticResRoot) {
                ...
                return {
                    init: function init(container, giftCardDetailUrl, loyaltyLedgerDetailUrl, customerInfoUrl, staticResRoot) {
            ...
            Toast.orderDetailSummary = function() {
                return {
                    init: function init(container, giftCardDetailUrl, loyaltyLedgerDetailUrl, customerInfoUrl) {
            ...
            Toast.giftCardDetail = function() {
                ...
                var updateCurrentBalance = function updateCurrentBalance(container) {
                ...
                var hideAdjustmentRow = function hideAdjustmentRow(container) {
                    $('#adjust-cancel').hide();
                    var activeTab = container.find('.tab-pane.active');
                ...
                var updateAdjustButton = function updateAdjustButton(container) {
                ...
                var changeRewardsEmail = function changeRewardsEmail(container) {
                ...
                var changeRewardsPhoneNumber = function changeRewardsPhoneNumber(container) {
                ...
                var showAppendedText = function showAppendedText(element) {
                    element.find('input').css('border-radius', '4px 0 0 4px');
                    element.find('.add-on').show();
                };
                var hideAppendedText = function hideAppendedText(element) {
                    element.find('input').css('border-radius', '4px');
                    element.find('.add-on').hide();
                };
                var hideAllAppendedText = function hideAllAppendedText(container) {
                    container.find('.input-append').each(function() {
                        hideAppendedText($(this));
                    });
                };
                return {
                    init: function init(container, storedValueDetailUrl, loyaltyPointsDetailUrl) {
            ...
            (function($) {
                $.fn.bootstrapifySelect = function(minWidth, maxWidth, disabled) {
                    ...
                    var handleAnchorClasses = function handleAnchorClasses(minWidthClass) {
                    ...
                    return this.each(function(i, e) {
                        ...
                        if (sel.data('convert') !== 'no' && sel.attr('bootstrapified') != 'true') {
                            ...
                            var style = (minWidth ? 'min-width:' + minWidth + ';' : '') + (maxWidth ? 'max-width:' + maxWidth + ';' : '');
                ...
                $.fn.toastSelectPicker = function() {
                    return this.each(function() {
                        ...
                        if (select.hasClass('firstSelectsAll')) {
                            ...
                            var updateSelectedName = function updateSelectedName() {
            ...
            $(function() {
                ...
                if (!Toast.isTouch()) {
                    ...
                    $('ul.selection-list li label').hover(function() {
                        $(this).addClass('hover');
                    }, function() {
                        $(this).removeClass('hover');
                    });
